...
//     empty translations and non-translated segmets. Markers used for this info can be changed (see the next block of vars)
...
langCodeHead = true // the header for the source and target fields: either language code (true), or a predifined string (false)
...
segmentID        = "ID"
note             = "Note"
altUniq          = "Alt/Uniq" //This field will contain info about repetitions, alternative translations, empty translation or untranslated segments
xStatus          = "xStatus"
origin           = "Origin"
...
for (i in 0 ..< files.size()) {
    ...
    for (j in 0 ..< fi.entries.size()) {
        ...
        nullTargetReplacement = "zzz" + new SimpleDateFormat("HHmmMMddyyyy").format(new Date()) + new Random().nextInt(1000000000) + "zzz"
        if (target == null) {
